...
/*
 * Unit tests for sparse utility operations:
 * - lmmc_sparse_add
 * - lmmc_sparse_scale
 * - lmmc_sparse_norm_fro
 * - lmmc_sparse_diag
 */
...
static int test_sparse_diag_non_square(void) {
    /* Non-square matrix should return INVALID_ARGUMENT */
    lmmc_mat_t dense = {0};
    lmmc_sparse_mat_t sparse = {0};
    lmmc_vec_t diag = {0};
    lmmc_status_t st;
...
static int test_sparse_add(void) {
    /* A = [1 0 2; 0 3 0; 4 0 5]
     * B = [0 6 0; 7 0 8; 0 9 0]
     * C = 2*A + 3*B = [2 18 4; 21 6 24; 8 27 10]
     */
    ...
    /* Expected: [2 18 4; 21 6 24; 8 27 10] */
...
static int test_sparse_add_dimension_mismatch(void) {
    /* A is 2x3, B is 3x3 -> should return DIMENSION_MISMATCH */
    lmmc_mat_t denseA = {0}, denseB = {0};
    lmmc_sparse_mat_t sparseA = {0}, sparseB = {0}, sparseC = {0};
    lmmc_status_t st;
